  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ========== 影子层（多层营造深度）========== */}
        <motion.g variants={shadowVariants} animate={animate ? 'animate' : undefined}>
          {/* 最外层淡影 */}
          <ellipse 
        ...
        <motion.ellipse 
          ...
          animate={animate ? 'animate' : undefined}
          style={{ originX: '38px', originY: '18px' }}
        />
 ...
 * 酒店切换专用加载动画
 */
export function HotelSwitchLoading({ hotelName }: { hotelName?: string }) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        <div className="text-lg font-medium text-text-primary mb-2">正在切换酒店</div>
        {hotelName && (
          <motion.div 
