        ...
        >
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="p-3 bg-neon-red/10 border border-neon-red/30 rounded-lg">
              ...
              <p className="text-sm text-gray-300">此价格低于房型底价，需要审批通过后才能生效</p>
            </div>
            <div className="p-3 bg-bg-tertiary rounded-lg">
              <span className="text-gray-300 text-sm block mb-1">申请原因</span>
              <p className="text-sm text-gray-200">{approval.reason}</p>
            </div>
