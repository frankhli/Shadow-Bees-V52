                          ...
                          {hasGrandChildren ? (
                            <button
                              ...
                              className={`flex items-center justify-between w-full px-4 py-2 text-sm rounded-lg transition-colors ${
                                childActive ? 'text-neon-cyan bg-neon-cyan/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary/50'
                              }`}
                            >
                            ...
                            <button
                              ...
                              className={`block w-full text-left px-4 py-2 text-sm rounded-lg transition-colors ${
                                isActive(child.path) ? 'text-neon-cyan bg-neon-cyan/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary/50'
                              }`}
                            >
                              {child.label}
                            </button>
                                ...
                                grandChild.isCustom ? (
                                  <button
                                    ...
                                    className={`block w-full text-left px-4 py-1.5 text-xs rounded-lg transition-colors ${
                                      isActive(grandChild.path) ? 'text-neon-cyan bg-neon-cyan/5' : 'text-text-secondary hover:text-text-primary hover:bg-bg-tertiary/50'
                                    }`}
                                  >
                                    {grandChild.label}
                                  </button>
