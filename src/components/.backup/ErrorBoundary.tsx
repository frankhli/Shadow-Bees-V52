    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-[#151B2B] rounded-2xl border border-gray-800 p-8 text-center">
            {/* 错误图标 */}
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-bg-primary border border-gray-700 rounded-lg hover:border-gray-600 transition-all text-sm"
                >
                  刷新页面
                </button>
                <button
                  onClick={this.handleGoHome}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-bg-primary border border-gray-700 rounded-lg hover:border-gray-600 transition-all text-sm"
                >
                  <Home size={16} />
                  返回首页
                </button>
