...
const roleConfig = {
  ...
  staff: { label: '员工', color: 'bg-gray-500/20 text-text-secondary border-gray-500/30', icon: User, iconBg: 'bg-text-muted/30' },
};
            ...
            >
              <Card className="p-4 shadow-lg bg-bg-secondary border-border-color">
                ...
                <div className="mt-4 p-3 bg-bg-primary rounded-lg text-xs text-text-secondary border border-border-color/50">
                  <div className="font-medium mb-2 flex items-center gap-1 text-text-secondary">
